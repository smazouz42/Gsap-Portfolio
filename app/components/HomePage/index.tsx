...
const VideoSection = () => {
  useGSAP(() => {
    ...
    gsap.fromTo('.title',
      { y: '100%', opacity: 0 },
      { y: '0%', opacity: 1, duration: 1.5, delay: 0.9, scrollTrigger: { start: 1 } }
    );
  ...
  return (
    <section className="video-section relative h-screen w-screen font-fira overflow-hidden">
      <div className="relative h-full w-full -z-20 flex items-center justify-center">
        ...
        <div className="hidden md:block w-1/2">
          <div className="photo-container relative w-[400px] h-[400px] mx-auto">
            <div className="absolute inset-[-10px] rounded-full">
              <div className="border-segment absolute inset-0 border-4 border-black rounded-full"
                style={{
                  clipPath: `polygon(
                      0 0, 40% 0, 40% 40%,
                      60% 40%, 60% 0, 100% 0,
        ...
        <div className="absolute inset-0 -z-30 bg-black bg-opacity-70">
          <video
